...
public class ConsultaValoracionAlimentacion implements Task {

    public static Response response;
    private DataTable dataTable;

    public ConsultaValoracionAlimentacion(DataTable dataTable) {
    ...
    public <T extends Actor> void performAs(T actor) {
        response= Base.request.header("x-dni-cliente",dataTable.cell(0,1))
                .when()
                .param("codigoValoracion",dataTable.cell(2,1))
                .get("api/assessment");
    }
}
